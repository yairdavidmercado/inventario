...
$sql = "CALL guardar_facturas('".$id_productos."','".$id_cliente."', '".$iva_factu."', '".$subtotal_factu."', '".$valor_factu."', '".$cuotas."', '".$tipo_venta."', '".$user_id."','".$state."');";
...
$conn->close();
>>>>>>> ff54b1330a41ac56be3a837ed3d2ab6bff5faa66
?>